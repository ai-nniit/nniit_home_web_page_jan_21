...
const BannerCarousel = () => {
  return (
    <div 
      id="bannerCarousel" 
      className="carousel slide p-10 mx-auto rounded-sm" 
    ...
    >
        ...
        <div className="carousel-item active" data-bs-interval="2000">
          <img 
            ...
            style={{ 
              ...
              objectFit: 'cover',
              width: '100%', 
            }} // Adjust banner size dynamically
          />
        </div>
        <div className="carousel-item" data-bs-interval="2000">
          <img 
      ...
      <style>
        {`
          /* Adjusting banner size for mobile devices */
          @media (max-width: 768px) {
            #bannerCarousel img {
              max-height: 350px; /* Increase banner height for mobile devices */
            }
          }
        `}
      </style>
