...
const CompanyShowcase = () => {
  ...
  return (
    <div className="bg-white">
      <header className="mb-4 px-3 md:ml-6">
  <div className="flex items-center space-x-1 mb-0.5">
    ...
    <p className="text-[10px] text-gray-400 mt-1 font-sf font-light">
      DISCOVER NEW PERSPECTIVES
    </p>
  </div>

  <h3 className="text-xl md:text-3xl font-extrabold font-sf text-black text-left">
    POWERED BY KNOWLEDGE OF IITIANS
  </h3>
</header>

      <div
        className="relative bg-cover bg-center -mt-5 text-white h-auto p-4"
