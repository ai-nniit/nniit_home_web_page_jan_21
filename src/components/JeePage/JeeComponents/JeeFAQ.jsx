...
const JeeFAQ = () => {
  ...
  const faqs = [
    {
      question: "What is NNIIT, and how does it help students preparing for JEE and other competitive exams?",
      answer: `NNIIT is a leading personalized learning platform specializing in one-on-one coaching for students preparing for JEE and other competitive exams. Our unique 1:1 learning model ensures that each student gets 100% personalized attention from an IIT faculty expert, along with flexible learning schedules and advanced performance tracking.
...
✅ Expert IIT Faculty – Learn directly from top educators with vast experience in JEE & other exams.
✅ Advanced Monitoring & Guidance – AI-powered progress tracking & real-time performance analysis.

This personalized approach helps students grasp concepts faster and improve their JEE rank efficiently.`,
    },
    {
      question: "What are the different JEE preparation programs offered by NNIIT?",
...
📌 Grade 9 – 4-Year JEE Classroom Program
📌 Grade 10 – 3-Year JEE Classroom Program
📌 Grade 11 – 2-Year JEE Classroom Program
📌 Grade 12 – 1-Year JEE Classroom Program
📌 12+ (Repeaters) – 1-Year Intensive JEE Crash Course
...
Each program is designed to build a strong foundation, improve problem-solving skills, and ensure exam success with expert guidance.`,
    ...
    {
      question: "What study materials does NNIIT provide for JEE preparation?",
...
📖 Tatva Books with 12,000+ JEE-focused questions for all difficulty levels.
...
These materials, combined with NNIIT’s one-on-one coaching, ensure the highest level of preparation for JEE and board exams.`,
    },
    {
...
📝 5 Part Tests – Covering key sections of JEE.
