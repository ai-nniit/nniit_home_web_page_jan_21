...
//   {/* Legend Box */}
//   <div className="absolute top-4 right-4 bg-white/10 backdrop-blur-sm p-4 rounded-lg shadow-lg z-10 md:block hidden">
...
//   {/* How to Use Box - Adjusted for mobile */}
//   <div className="absolute bottom-4 left-4 bg-white/10 backdrop-blur-sm p-3 rounded-lg shadow-lg z-10 max-w-xs md:max-w-sm md:p-4 hidden md:block ">
...
//   <div className="absolute -bottom-6 left-4 bg-white/10 backdrop-blur-sm p-3 rounded-lg shadow-lg z-10 max-w-xs md:max-w-sm md:p-4 md:hidden">
//     <h3 className="text-black text-sm font-semibold mb-2">How to Use</h3>
//     <ul className="text-black text-xs space-y-2">
//       <li>• Hover over nodes to see concept questions</li>
//       <li>• Click a node to zoom in and focus</li>
//       <li>• Drag to pan around the graph</li>
//       <li>• Use mouse wheel or buttons to zoom</li>
//       <li>• Best viewed on a laptop or desktop.</li>
//     </ul>
//   </div>
  
//   {/* Mobile Legend (hidden on desktop) */}
//   <div className="absolute top-2 left-2 bg-white/10 backdrop-blur-sm p-1 rounded-lg shadow-lg z-10 block md:hidden">
//     <h3 className="text-white text-sm font-semibold mb-1">Legend</h3>
//     <div className="flex flex-col gap-1">
//       <div className="flex items-center gap-2">
//         <div className="w-1 h-1 rounded-full bg-[#FF3366]"></div>
//         <span className="text-white text-[12px]">Core</span>
//       </div>
//       <div className="flex items-center gap-2">
//         <div className="w-1 h-1 rounded-full bg-[#00B4D8]"></div>
//         <span className="text-white text-[12px]">Concepts</span>
//       </div>
//       <div className="flex items-center gap-2">
//         <div className="w-1 h-1 rounded-full bg-[#06D6A0]"></div>
//         <span className="text-white text-[12px]">Related</span>
//       </div>
//     </div>
//   </div>
...
const NetworkGraph = ({ data }) => {
  ...
  useEffect(() => {
    ...
    const nodes = g.append("g")
      ...
      .on("mouseout", () => {
        resetHighlight();
        // Only hide tooltip if we're not in a clicked state
        if (!isNodeClicked) {
          tooltip.style("visibility", "hidden");
        }
      });
    ...
    function showTooltipForNode(event, d) {
      isNodeClicked = true;
      clickedNodeId = d.id;
      tooltip
        .style("visibility", "visible")
    ...
    // Add click handler to svg to close tooltip when clicking outside
    svg.on("click", (event) => {
  ...
  return (
    <div className="relative w-full h-full min-h-[400px]">
      ...
      <div className="absolute bottom-4 left-4 bg-white/10 backdrop-blur-sm p-3 rounded-lg shadow-lg z-10 max-w-xs md:max-w-sm md:p-4 hidden md:block">
        <h3 className="text-white text-sm font-semibold mb-2">How to Use</h3>
        <ul className="text-white/90 text-xs space-y-2">
          <li>• Click nodes to see concept questions</li>
          <li>• Click a node to zoom in and focus</li>
          <li>• Drag to pan around the graph</li>
          <li>• Use mouse wheel or buttons to zoom</li>
          <li>• Connections highlight on hover</li>
      ...
      <div className="absolute -bottom-6 left-4 bg-white/10 backdrop-blur-sm p-3 rounded-lg shadow-lg z-10 max-w-xs md:max-w-sm md:p-4 md:hidden">
        ...
        <ul className="text-black text-xs space-y-2">
          ...
          <li>• Click a node to zoom in and focus</li>
          <li>• Drag to pan around the graph</li>
          <li>• Use pinch gestures to zoom</li>
          <li>• Best viewed on a laptop or desktop</li>
        </ul>
      </div>
