...
//   const touchStartY = useRef(0); // Store initial touch position
//   const touchStartTime = useRef(0); // Store the time of touch start
//   const touchEndY = useRef(0); // Store final touch position
...
//     if (deltaY > 50 && currentIndex < features.length - 1) {
//       // Swipe up
//       lockScroll();
...
//       lockScroll();
//       setCurrentIndex((prevIndex) => prevIndex - 1);
//     } else if (deltaY > 50 && currentIndex === features.length - 1) {
//       // At the last card, allow page scrolling
//       unlockScroll();
//     } else if (deltaY < -50 && currentIndex === 0) {
//       // At the first card, allow page scrolling
//       unlockScroll();
//     }
...
//         Features We Provide
//       </h2>
//       {/* <p className="text-lg text-gray-600 max-w-2xl mx-auto px-4 mb-10">
...
//           <div
//             key={index}
//             className={`absolute w-[90%] h-[55%] flex flex-col items-center justify-center p-4 md:p-8 rounded-lg shadow-lg ${feature.bgColor} transform transition-transform duration-[var(--card-transition-duration,1500ms)] ease-in-out ${
//               index === currentIndex
//                 ? "translate-y-0 opacity-100 scale-100 z-10"
//                 : index < currentIndex
//                 ? "-translate-y-[30%] opacity-80 scale-90 z-0"
//                 : "translate-y-[30%] opacity-80 scale-90 z-0"
//             }`}
//             style={{
...
//             }}
//           >
//             <div className="h-[45%] flex flex-col items-start justify-start w-full px-4">
...
//               </p>
//             </div>
//             <div className="h-[55%] w-full bg-cover bg-center rounded-b-lg overflow-hidden" style={{ backgroundImage: `url(${feature.image})` }}></div>
//           </div>
//         ))}
//       </div>
//     </div>
...
//           cardVisibility.current[index] = entry.intersectionRatio >= 0.9; // Check if 80% is visible
//         });
//       },
//       {
//         threshold: [1], // Trigger when 80% is visible
//       }
//     );
...
//             className={`feature-card absolute w-[90%] h-[55%] flex flex-col items-center justify-center p-4 md:p-8 rounded-lg shadow-lg ${feature.bgColor} transform transition-transform duration-[var(--card-transition-duration,1500ms)] ease-in-out ${
//               index === currentIndex
//                 ? "translate-y-0 opacity-100 scale-100 z-10"
//                 : index < currentIndex
//                 ? "-translate-y-[30%] opacity-80 scale-90 z-0"
