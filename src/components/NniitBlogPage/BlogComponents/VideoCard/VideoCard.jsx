...
// const categories = ['Off-Campus', 'Entrepreneurship', 'Leadership', 'Other'];

// const videos = {
//   'Off-Campus': [
//     {
//       title: 'Inside Physics Wallah HQ',
//       description: 'A Deep Dive Into the Workings of a Billion Dollar Ed-Tech Company | PhysicsWallah',
//       thumbnail: 'path/to/thumbnail1.jpg',
//     },
//     {
//       title: 'Inside BYJU’s HQ',
//       description: 'An Exclusive Look Into the Success of India’s Largest Ed-Tech Platform.',
//       thumbnail: 'path/to/thumbnail2.jpg',
//     },
//   ],
//   'Entrepreneurship': [
//     {
//       title: 'Startup Stories: Paytm Journey',
//       description: 'The Rise of Paytm From a Startup to a Fintech Giant.',
//       thumbnail: 'path/to/startup-thumbnail1.jpg',
//     },
//   ],
//   'Leadership': [
//     {
//       title: 'Leading in Uncertainty: Sundar Pichai',
//       description: 'Google CEO Shares Leadership Strategies for the Modern Era.',
//       thumbnail: 'path/to/leadership-thumbnail1.jpg',
//     },
//   ],
//   'Other': [
//     {
//       title: 'AI for Good',
//       description: 'How AI is Being Used to Solve Real-World Problems.',
//       thumbnail: 'path/to/other-thumbnail1.jpg',
//     },
//   ],
// };

// const VideoCard = () => {
//   const [selectedCategory, setSelectedCategory] = useState('Off-Campus');

//   return (
//     <div className="min-h-64 p-1 bg-white text-black">
//       {/* Header */}
//       <header className="flex items-center space-x-2 mb-4 px-4">
//         {/* SVG Icon */}
//         <svg
...
//           Knowledge at the Union
//         </h1>
//       </header>

//       {/* Navigation */}
//       <nav className="flex justify-around md:justify-center md:space-x-4 overflow-x-auto mb-3 px-2">
//         {categories.map((category) => (
//           <button
//             key={category}
//             className={`text-sm px-6 py-1 rounded-full whitespace-nowrap ${
//               selectedCategory === category
//                 ? 'bg-white text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400'
//                 : 'text-gray-400'
//             }`}
...
//       {/* Video Cards Slide */}
//       <main className="overflow-x-auto px-4">
//         <div className="flex space-x-4">
//           {videos[selectedCategory].map((video, index) => (
//             <div
//               key={index}
//               className="w-60 bg-gray-800 rounded-lg shadow-lg p-2 shrink-0"
//             >
//               {/* Image */}
...
//               <h2 className="text-xs font-semibold mb-1">{video.title}</h2>
//               <p className="text-[10px] text-gray-400">{video.description}</p>
//             </div>
//           ))}
//         </div>
//       </main>
